...
from lab04.interfaces import Displayable, Attackable, Upgradable
class Weapon:
...
# Класс меча :) 
class Sword(Weapon, Displayable, Attackable, Upgradable):
...
# Класс лука
class Bow(Weapon, Displayable, Attackable, Upgradable):
    ...
    def attack_power(self)-> int:
        """Реализация Attackable для лука +5 """
