...
| `get_legendary()` | Только легендарное |
| `get_epic()` | Только эпическое |
| `get_rare()` | Только редкое |
| `get_common()` | Только обычное |
| `get_broken()` | Только сломанное |
| `get_repairable()` | Требующие ремонта |
